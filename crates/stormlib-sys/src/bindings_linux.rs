...
const _: () = {
  ["Size of _SFILE_FIND_DATA"][::std::mem::size_of::<_SFILE_FIND_DATA>() - 1064usize];
  ...
  ["Offset of field: _SFILE_FIND_DATA::szPlainName"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, szPlainName) - 1024usize];
  ["Offset of field: _SFILE_FIND_DATA::dwHashIndex"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwHashIndex) - 1032usize];
  ["Offset of field: _SFILE_FIND_DATA::dwBlockIndex"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwBlockIndex) - 1036usize];
  ["Offset of field: _SFILE_FIND_DATA::dwFileSize"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwFileSize) - 1040usize];
  ["Offset of field: _SFILE_FIND_DATA::dwFileFlags"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwFileFlags) - 1044usize];
  ["Offset of field: _SFILE_FIND_DATA::dwCompSize"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwCompSize) - 1048usize];
  ["Offset of field: _SFILE_FIND_DATA::dwFileTimeLo"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwFileTimeLo) - 1052usize];
  ["Offset of field: _SFILE_FIND_DATA::dwFileTimeHi"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, dwFileTimeHi) - 1056usize];
  ["Offset of field: _SFILE_FIND_DATA::lcLocale"]
    [::std::mem::offset_of!(_SFILE_FIND_DATA, lcLocale) - 1060usize];
};
